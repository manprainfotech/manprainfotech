...
const products = [
  {
    ...
    imageUrl: "https://placehold.co/800x600/png?text=Quick+Heal+Total+Security+TR1",
    mrp: 9999,
    price: 6999,
    deliveryType: "Instant Email + WhatsApp",
    tags: "antivirus,1pc,1year,TR1",
  },
  {
    slug: "quick-heal-total-security-ts1-1pc-3y",
    title: "Quick Heal Total Security (TS1) 1PC 3Y",
    brand: "Quick Heal",
    shortDescription: "3-year total security with advanced ransomware protection.",
    imageUrl: "https://placehold.co/800x600/png?text=Quick+Heal+Total+Security+TS1",
    mrp: 19999,
    price: 12999,
    deliveryType: "Instant Email + WhatsApp",
    tags: "antivirus,1pc,3year,TS1",
  },
  {
    slug: "quick-heal-antivirus-pro-lr1-1pc-1y",
    title: "Quick Heal Antivirus Pro (LR1) 1PC 1Y",
    brand: "Quick Heal",
    shortDescription: "Essential antivirus protection with real-time scanning for 1 PC.",
    imageUrl: "https://placehold.co/800x600/png?text=Quick+Heal+Antivirus+Pro+LR1",
    mrp: 6999,
    price: 4999,
    deliveryType: "Instant Email + WhatsApp",
    tags: "antivirus,1pc,1year,LR1",
  },
  {
    slug: "quick-heal-internet-security-1pc-1y",
    title: "Quick Heal Internet Security 1PC 1Y",
    brand: "Quick Heal",
    shortDescription: "Internet security with anti-phishing and safe banking tools.",
    imageUrl: "https://placehold.co/800x600/png?text=Quick+Heal+Internet+Security",
    mrp: 7999,
    price: 5999,
    deliveryType: "Instant Email + WhatsApp",
    tags: "antivirus,1pc,1year,internet-security",
  },
  {
